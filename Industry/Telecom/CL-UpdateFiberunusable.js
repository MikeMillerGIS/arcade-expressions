...
var sqlquery = 'assettype = 163 and strandstatus = 5';
...
var fiberavailable = get_features_counts_by_query(associated_ids,'assettype = 163 and strandstatus = 1');
var fiberused = get_features_counts_by_query(associated_ids,'assettype = 163 and strandstatus = 2');
var fiberreserved = get_features_counts_by_query(associated_ids,'assettype = 163 and strandstatus = 3');
var fiberdedicated = get_features_counts_by_query(associated_ids,'assettype = 163 and strandstatus = 4');
var fiberunusable = get_features_counts_by_query(associated_ids,'assettype = 163 and strandstatus = 5');
var fiberpendingconnect = get_features_counts_by_query(associated_ids,'assettype = 163 and strandstatus = 6');
var fiberpendingdisconnect = get_features_counts_by_query(associated_ids,'assettype = 163 and strandstatus = 7');
